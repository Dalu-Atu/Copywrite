...
export async function generateMetadata({ params }) {
  ...
  const t = await getTranslations({ locale, namespace: "PhotoToWord" });
  ...
  return {
    ...
    alternates: {
      canonical: `https://noteocr.com${localePath}/photo-to-word`,
      languages: {
        "x-default": "https://noteocr.com/photo-to-word",
        en: "https://noteocr.com/photo-to-word",
        es: "https://noteocr.com/es/photo-to-word",
        tr: "https://noteocr.com/tr/photo-to-word",
        zh: "https://noteocr.com/zh/photo-to-word",
        hi: "https://noteocr.com/hi/photo-to-word",
        de: "https://noteocr.com/de/photo-to-word",
        ja: "https://noteocr.com/ja/photo-to-word",
        fr: "https://noteocr.com/fr/photo-to-word",
        "pt-br": "https://noteocr.com/pt-br/photo-to-word",
        da: "https://noteocr.com/da/photo-to-word",
        fi: "https://noteocr.com/fi/photo-to-word",
        it: "https://noteocr.com/it/photo-to-word",
        nl: "https://noteocr.com/nl/photo-to-word",
        no: "https://noteocr.com/no/photo-to-word",
        sv: "https://noteocr.com/sv/photo-to-word",
      },
    },
    openGraph: {
      title: t("meta_title"),
...
export default async function PhotoToWord({ params }) {
  const { locale } = await params;
  const t = await getTranslations({ locale, namespace: "PhotoToWord" });
  const localePath = locale === "en" ? "" : `/${locale}`; // 👈 same helper logic
    ...
    <div className="min-h-screen bg-[#000] text-white selection:bg-blue-500/30">
      ...
      <section className="relative pt-32 pb-32 flex flex-col items-center justify-center px-5 overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 text-center max-w-5xl px-2">
          ...
          {/* THE TOOL */}
          <ToolInterface locale={locale} translation={"PhotoToWord"} />
