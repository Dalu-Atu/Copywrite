  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        hi: "https://noteocr.com/hi/pic-to-excel",
        de: "https://noteocr.com/de/pic-to-excel",
        ja: "https://noteocr.com/ja/pic-to-excel",
        fr: "https://noteocr.com/fr/pic-to-excel",
        "pt-br": "https://noteocr.com/pt-br/pic-to-excel",
        da: "https://noteocr.com/da/pic-to-excel",
        fi: "https://noteocr.com/fi/pic-to-excel",
        it: "https://noteocr.com/it/pic-to-excel",
        nl: "https://noteocr.com/nl/pic-to-excel",
        no: "https://noteocr.com/no/pic-to-excel",
        sv: "https://noteocr.com/sv/pic-to-excel",
      },
    },
    openGraph: {
      title: t("meta_title"),
      description: t("meta_desc"),
      images: ["/images/excel-graph.png"],
    },
  };
}
    ...
    <div className="min-h-screen bg-[#000] text-white selection:bg-emerald-500/30">
      ...
      <section className="relative pt-32 pb-32 flex flex-col items-center justify-center px-5 overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 text-center max-w-5xl px-2">
          ...
          {/* THE TOOL */}
          <ExcelToolInterface locale={locale} translation={"pic-to-excel"} />
