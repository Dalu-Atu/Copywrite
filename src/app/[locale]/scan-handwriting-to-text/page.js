  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        hi: "https://noteocr.com/hi/scan-handwriting-to-text",
        de: "https://noteocr.com/de/scan-handwriting-to-text",
...
export default async function ScanHandwritingToText({ params }) {
  const { locale } = await params;
  const t = await getTranslations({
    locale,
    namespace: "ScanHandwritingToText",
    ...
    <div className="min-h-screen bg-[#000] text-white selection:bg-blue-500/30">
      ...
      <section className="relative pt-32 pb-32 flex flex-col items-center justify-center px-5 overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 text-center max-w-5xl px-2">
          ...
          <ToolInterface
            locale={locale}
            translation={"ScanHandwritingToText"}
          />
