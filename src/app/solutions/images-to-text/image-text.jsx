...
const structuredData = {
  ...
  applicationSubCategory: "OCR Software",
  operatingSystem: "Web",
  offers: {
    "@type": "Offer",
    price: "0",
  ...
  description:
    "AI-powered OCR software that converts handwritten notes to editable digital text with high accuracy.",
  featureList:
    "Handwriting recognition, Image to text conversion, PDF OCR, Multilingual support",
  keywords:
    "handwriting to text, OCR, handwriting recognition, AI text conversion",
};
function LifeTooShortForTyping() {
  ...
  return (
    <>
      <Head>
        <title>
          Convert images to text | Life's Too Short for Typing| 98% say they
          never type again
        </title>
        <meta
          name="description"
          ...
          >
            ...
            >
              <div className="aspect-w-16 aspect-h-9 bg-black bg-opacity-20">
                ...
                >
                  <source src="/image-text-video.webm" type="video/webm" />
                </video>
                {!isPlaying && (
...
export default LifeTooShortForTyping;
