import NotesToWord from "./note-to-word";
...
export const metadata = {
  ...
  keywords:
    "image to word, edit document online, word to pdf, image to pdf, handwritting to text, image to text",
  alternates: {
    canonical: "https://copywritee.com/solutions/notes-to-word",
  },
};

const NotesToWordPage = () => {
  return (
    <>
      <NotesToWord />
    </>
...
export default NotesToWordPage;
